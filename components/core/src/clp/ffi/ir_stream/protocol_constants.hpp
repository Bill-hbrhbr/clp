...
constexpr std::enable_if<sizeof(EightByteEncodingMagicNumber)
                                 == sizeof(FourByteEncodingMagicNumber),
                         size_t>::type MagicNumberLength = sizeof(EightByteEncodingMagicNumber);
