...
public:
    ...
    virtual void push_intra_stage_record_group(GroupTags const& tags,
                                               ConstRecordIterator& record_it) = 0;
    virtual void push_inter_stage_record_group(GroupTags const& tags,
                                               ConstRecordIterator& record_it) = 0;
