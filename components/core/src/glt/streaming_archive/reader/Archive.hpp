...
public:
     ...
     */
    bool find_message_matching_with_logtype_query(std::vector<LogtypeQuery> const& logtype_query,
                                                  Message& msg,
                                                  bool& wildcard,
                                                  Query const& query);
    /**
    ...
    size_t decompress_messages_and_output(logtype_dictionary_id_t logtype_id,
     ...
     * @throw TimestampPattern::OperationFailed if failed to insert timestamp
     */
    bool decompress_message_with_fixed_timestamp_pattern(Message const& compressed_msg,
                                                         std::string& decompressed_msg);
